...
suit :
1. La première ligne correspond aux coordonnées du coin supérieur droit de la
pelouse, celles du coin inférieur gauche sont supposées être (0,0)
1. La suite du fichier permet de piloter toutes les tondeuses qui ont été
...
***NB*** : 
Les données en entrée sont injectées sous forme de fichier.